...
// images
import EtchDemo from "../../public/demo-images/etch-a-sketch.gif";
...
# Etch A Sketch
<DemoImage src={EtchDemo} width={1000} height={483} alt="dekstop demo"/>
## Overview

Objective is to create a web-browser version of something between a sketchpad and an Etch-A-Sketch using Javascript DOM manipulation and CSS grid. 
